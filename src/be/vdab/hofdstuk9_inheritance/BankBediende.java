...
public class BankBediende {
    public static void main(String[] args) {
        ...
        var spar =  rekeningen[0]; // ==> Dit is DOWNCASTING

        System.out.println("deneme ==> "+rekeningen[0]);
        ...
        rekeningen[0].storten(500.0); // Spaarrekening klasinda storten() metodu olmamasina ragmen Rekening
        // base klasindan alip kullaniyor. Dit is UPCASTING.
